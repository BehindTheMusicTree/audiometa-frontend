  ...
  return (
    <header className="relative flex flex-none items-center justify-end gap-4 border-b border-amber-500/20 bg-linear-to-b from-slate-900 to-slate-800 px-6 py-4 shadow-lg">
      ...
      <Link
        ...
        className="absolute left-1/2 top-1/2 z-0 flex max-w-[calc(100%-8rem)] -translate-x-1/2 -translate-y-1/2 items-center gap-3 rounded-sm text-white outline-offset-4 focus-visible:outline focus-visible:outline-2 focus-visible:outline-amber-400/80"
